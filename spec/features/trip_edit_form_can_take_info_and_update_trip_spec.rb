...
describe "when user clicks the 'Edit' button on the trip details page..." do
  ...
  describe "the user is able to fill out the edit form..." do
    it "and update the start station" do
      ...
      expect(page.all("//td[@class='start-station']")[0].text).to eq("West Earl Ave")
    end
    ...
    describe "and update the start date" do
      it "" do
        ...
        expect(page.all("//td[@class='start-date']")[0].text).to eq("01/01/2017 11:11:00")
      end
      ...
      it "... which automatically updates the duration" do
        ...
        expect(page.all("//td[@class='duration']")[0].text).to eq("240")
      end
    end
    ...
    describe "and update the end date" do
      it "" do
        ...
        expect(page.all("//td[@class='end-date']")[0].text).to eq("01/01/2017 11:16:00")
      end
      ...
      it "... which automatically updates the duration" do
        ...
        expect(page.all("//td[@class='duration']")[0].text).to eq("360")
      end
    end
    ...
    it "and update the bike id" do
      ...
      expect(page.all("//td[@class='bike-id']")[0].text).to eq("200")
    end
    ...
    describe "and update the zip code..." do
      it "with a 5 digit string" do
        ...
        expect(page.all("//td[@class='zip-code']")[0].text).to eq("67890")
      end
      ...
      it "with a 4 digit string" do
        ...
        expect(page.all("//td[@class='zip-code']")[0].text).to eq("06789")
      end
      ...
      it "to a blank field" do
        ...
        expect(page.all("//td[@class='zip-code']")[0].text).to eq("")
      end
    end
  end
end
